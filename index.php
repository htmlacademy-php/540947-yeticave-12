...
$show_new_lot = $mysqli->query(
    "SELECT l.id, l.name_lot, l.start_price, l.img_path, c.title, l.date_end
                            FROM lot l
...
$layout_content = include_template(
    'layout.php',
    ['main_content' => $page_content, 'title' => 'Интернет-аукцион «YetiCave»', 'categories' => $all_categories]
);
