...
VALUES
    ('1', '4', '1', NOW(), 'DC Ply Mens 2016/2017 Snowboard', 'Легкий маневренный сноуборд для фристайла.', 'img/lot-2.jpg', '15999', '2021-11-29', '1000'),
    ('3', '4', '2', NOW(), 'Крепления Union Contact Pro 2015 года размер L/XL', 'Удобные и прочные крепления для комфортной езды', 'img/lot-3.jpg', '8000', '2021-11-30', '200'),
    ('1', '2', '3', NOW(), 'Ботинки для сноуборда DC Mutiny Charocal', 'Комфортные и жесткие ботинки. В самый раз для новичков', 'img/lot-4.jpg', '10999', '2021-12-05', '500'),
    ('2', '3', '4', NOW(), 'Куртка для сноуборда DC Mutiny Charocal', 'Отлчиная куртка, мембрана - 10к, в самый раз для комфорной езды в горах', 'img/lot-5.jpg', '7500', '2021-12-31', '500'),
    ('4', '1', '6', NOW(), 'Маска Oakley Canopy', 'Незаменимый атрибут в сильный снегопад', 'img/lot-6.jpg', '5400', '2021-12-07', '100'),
    ('4', '1', '1', NOW(), '2014 Rossignol District Snowboard', 'Прекрасный сноуборд для тех, кто любит фрирайд', 'img/lot-1.jpg', '10999', '2021-12-28', '1000');
